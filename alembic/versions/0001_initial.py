...
def upgrade() -> None:
    ...
    op.create_table('users',
        ...
        sa.Column('can_read_all_groups_messages', sa.Boolean(), nullable=True),
    ...
    op.create_table('drink_records',
        ...
        sa.Column('drink_name', sa.String(length=255), nullable=False),
    ...
    op.create_index('idx_user_created', 'drink_records', ['user_id', 'created_at'], unique=False)
    op.create_index('idx_created_at', 'drink_records', ['created_at'], unique=False)
